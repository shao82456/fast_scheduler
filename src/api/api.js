...
export const getTaskListPage = params => { return axios.get(`${base}/task/list`, { params: params }); };
export const httpRemoveTask= params => { return axios.get(`${base}/task/remove`,{ params: params }); };
...
export const enableTask= params => { return axios.post(`${base}/task/cron`,params); };
...
export const httpSaveTask=(flowId,params) => { return axios.post(`${base}/flow/updateTask/`+flowId, params); };
...
export const httpUnscheduleTask =params => { return axios.get(`${base}/task/uncron`,{ params: params }); };
